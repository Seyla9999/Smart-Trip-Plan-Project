...
import Admin_Destination from '../views/Admin/Admin_Destination.vue'
import Admin_Moderation from '../views/Admin/Admin_Moderation.vue'
import Admin_User from '../views/Admin/Admin_User.vue'
import Admin_Setting from '../views/Admin/Admin_Setting.vue'
import Admin_Sponsor from '../views/Admin/Admin_Sponsor.vue'
...
import TripPlannerView from '../views/Trip/TripPlannerView.vue'
import TripFormView from '../views/Trip/TripFormView.vue'
import TripResultsView from '../views/Trip/TripResultsView.vue'
import TripJoinView from '../views/Trip/TripJoinView.vue'
import MapView from '../views/MapView.vue'
import ProfileView from '../views/ProfileView.vue'
import MyTripsView from '../views/Trip/MyTripsView.vue'
