  ...
  <section class="section">
    ...
    <div v-else class="results-grid">
      ...
      >
        ...
        <div class="rc-body">
          <div class="rc-prov">Ã°Å¸â€œÂ {{ item.province }}</div>
          <div class="rc-foot">
    ...
    <div class="see-all-row">
      ...
      See all {{ activeCat }} attractions Ã¢â€ â€™
</a>
    </div>
  </section>
</template>
...
const STAR_MAP = [0,'Ã¢Ëœâ€¦Ã¢Ëœâ€ Ã¢Ëœâ€ Ã¢Ëœâ€ Ã¢Ëœâ€ ','Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ Ã¢Ëœâ€ Ã¢Ëœâ€ ','Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ Ã¢Ëœâ€ ','Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ','Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦']

const FALLBACK_DATA: Record<string, DisplayItem[]> = {
  Sea: [
    { name: 'Long Beach',        province: 'Koh Kong',      image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=500&q=80', color: '#2196A6', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 312 },
    { name: 'Koh Ta Kiev',       province: 'Sihanoukville', image: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=500&q=80', color: '#1A7A8A', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 198 },
    { name: 'Koh Rong Island',   province: 'Sihanoukville', image: 'https://images.unsplash.com/photo-1511497584788-876760111969?w=500&q=80', color: '#2D6A4F', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 145 },
    { name: 'Koh Kong Island',   province: 'Koh Kong',      image: 'https://images.unsplash.com/photo-1564760055775-d63b17a55c44?w=500&q=80', color: '#3E6B47', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 87  },
  ],
  Waterfall: [
    { name: 'Tatai Waterfall',   province: 'Koh Kong',      image: 'https://images.unsplash.com/photo-1564760055775-d63b17a55c44?w=500&q=80', color: '#2D6A8F', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 743 },
    { name: 'Bou Sra Waterfall', province: 'Mondulkiri',    image: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=500&q=80', color: '#3E6B47', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 421 },
    { name: 'Popokvil Falls',    province: 'Kampot',        image: 'https://images.unsplash.com/photo-1540541338287-41700207dee6?w=500&q=80', color: '#5C7A3E', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 287 },
    { name: 'Kbal Chhay',        province: 'Sihanoukville', image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=500&q=80', color: '#2196A6', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ Ã¢Ëœâ€ ', reviews: 183 },
  ],
  Temple: [
    { name: 'Angkor Wat',        province: 'Siem Reap',     image: 'https://images.unsplash.com/photo-1538964173425-93884e739ccd?w=500&q=80', color: '#4A7C59', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 2341 },
    { name: 'Bayon Temple',      province: 'Siem Reap',     image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=500&q=80', color: '#5B5EA6', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 1654 },
    { name: 'Ta Prohm',          province: 'Siem Reap',     image: 'https://images.unsplash.com/photo-1538964173425-93884e739ccd?w=500&q=80', color: '#6B4C3B', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 543  },
    { name: 'Preah Vihear',      province: 'Preah Vihear',  image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=500&q=80', color: '#7A6030', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 876  },
  ],
  Nature: [
    { name: 'Yeak Laom Lake',     province: 'Ratanakiri',   image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=500&q=80', color: '#6B4C3B', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 512 },
    { name: 'Cardamom Mountains', province: 'Koh Kong',     image: 'https://images.unsplash.com/photo-1511497584788-876760111969?w=500&q=80', color: '#2D6A4F', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 398 },
    { name: 'Elephant Valley',    province: 'Mondulkiri',   image: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=500&q=80', color: '#5C7A3E', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 445 },
    { name: 'Virachey Park',      province: 'Ratanakiri',   image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=500&q=80', color: '#3E6B47', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 198 },
  ],
  Food: [
    { name: 'Kep Crab Market',    province: 'Kep',          image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=500&q=80', color: '#3D8B8B', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 654 },
    { name: 'Phsar Thmei',        province: 'Phnom Penh',   image: 'https://images.unsplash.com/photo-1598946329549-8ac25a6c2890?w=500&q=80', color: '#3D5A80', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 421 },
    { name: 'Old Market SR',      province: 'Siem Reap',    image: 'https://images.unsplash.com/photo-1538964173425-93884e739ccd?w=500&q=80', color: '#4A7C59', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 387 },
    { name: 'Night Market Kampot',province: 'Kampot',       image: 'https://images.unsplash.com/photo-1540541338287-41700207dee6?w=500&q=80', color: '#5C7A3E', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 276 },
  ],
  Pagoda: [
    { name: 'Silver Pagoda',      province: 'Phnom Penh',   image: 'https://images.unsplash.com/photo-1598946329549-8ac25a6c2890?w=500&q=80', color: '#3D5A80', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 987 },
    { name: 'Wat Phnom',          province: 'Phnom Penh',   image: 'https://images.unsplash.com/photo-1598946329549-8ac25a6c2890?w=500&q=80', color: '#5B5EA6', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 765 },
    { name: 'Phnom Sampov',       province: 'Battambang',   image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=500&q=80', color: '#7A6030', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 312 },
    { name: 'Wat Banan',          province: 'Battambang',   image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=500&q=80', color: '#6B7C3E', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ Ã¢Ëœâ€ ', reviews: 156 },
  ],
  Culture: [
    { name: 'Royal Palace',       province: 'Phnom Penh',   image: 'https://images.unsplash.com/photo-1598946329549-8ac25a6c2890?w=500&q=80', color: '#3D5A80', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 1876 },
    { name: 'Killing Fields',     province: 'Phnom Penh',   image: 'https://images.unsplash.com/photo-1598946329549-8ac25a6c2890?w=500&q=80', color: '#6B4C3B', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ ', reviews: 1234 },
    { name: 'Apsara Dance Show',  province: 'Siem Reap',    image: 'https://images.unsplash.com/photo-1538964173425-93884e739ccd?w=500&q=80', color: '#4A7C59', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 987  },
    { name: 'Phare Circus',       province: 'Battambang',   image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=500&q=80', color: '#2196A6', rating: 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦', reviews: 432  },
  ],
}
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const categories = [
      { name: 'Sea',       icon: 'Ã°Å¸Å’Å ' },
      { name: 'Waterfall', icon: 'Ã°Å¸â€™Â§' },
      { name: 'Temple',    icon: 'Ã°Å¸Ââ€ºÃ¯Â¸Â' },
      { name: 'Nature',    icon: 'Ã°Å¸Å’Â¿' },
      { name: 'Food',      icon: 'Ã°Å¸ÂÅ“' },
      { name: 'Pagoda',    icon: 'Ã°Å¸â€¢Å’' },
      { name: 'Culture',   icon: 'Ã°Å¸Å½Å½' },
    ]
    ...
    function mapAttraction(a: Attraction): DisplayItem {
      ...
      return {
        ...
        color:    '#4A7C59',
        rating:   STAR_MAP[rating] as string || 'Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ Ã¢Ëœâ€ ',
