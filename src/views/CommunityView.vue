...
const trendingPlaces = ref<TrendingPlace[]>([
  {
    ...
    category: 'Cultural',
    mentions: 90,
    summary: 'Temple stories and sunset tours are getting the most attention this week.',
    visits: 5234,
  },
  {
    id: 2,
    ...
    category: 'Natural',
    mentions: 78,
    summary: 'Boat trips and floating home photography continue to trend among visitors.',
    visits: 3421,
  },
  {
    id: 3,
    ...
    category: 'Sea',
    mentions: 64,
    summary: 'Clear shorelines and quiet bays are drawing in more travel stories.',
    visits: 2890,
  },
  {
    id: 4,
    ...
    category: 'Waterfall',
    mentions: 53,
    summary: 'River carvings and jungle hikes are becoming a must-see for adventure seekers.',
    visits: 1567,
  },
  {
    id: 5,
    name: 'Phnom Penh Markets',
    province: 'Phnom Penh',
    category: 'Cultural',
    mentions: 69,
    summary: 'Local food stalls and night market finds are stealing the spotlight in stories.',
    visits: 2103,
  },
])
...
const popularProvinces = ref<PopularProvince[]>([
  {
    ...
    name: 'Siem Reap',
    slug: 'siem-reap',
    image: '/provinces/siem-reap.jpg',
    storyCount: 523,
    descriptor: 'Temple tours, cuisine, and river-side strolls',
    stories: 523,
  },
  {
    id: 2,
    name: 'Phnom Penh',
    slug: 'phnom-penh',
    image: '/provinces/phnom-penh.jpg',
    storyCount: 412,
    descriptor: 'Markets, museums, and riverside sunsets',
    stories: 412,
  },
  {
    id: 3,
    name: 'Sihanoukville',
    slug: 'sihanoukville',
    image: '/provinces/sihanoukville.jpg',
    storyCount: 287,
    descriptor: 'Beaches, island hops, and fresh seafood finds',
    stories: 287,
  },
])
