    ...
    <div class="auth-form-panel">
      <div class="auth-form-container">
        ...
        <p class="terms-text">
          ...
          <RouterLink to="/terms" class="terms-link">Terms of Service</RouterLink>
          and
          <RouterLink to="/privacy" class="terms-link">Privacy Policy</RouterLink>
        </p>
...
async function handleSignUp() {
  ...
  try {
    ...
    apiError.value = err?.message ?? 'Sign up failed. Please try again.'
  } finally {
